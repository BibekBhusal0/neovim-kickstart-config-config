...
M.organize_mappings = function()
  ...
  for _, mode in ipairs(modes) do
    ...
    require("core.cheatsheet").get_mappings(keymaps, tb_to_add)

    local bufkeymaps = vim.api.nvim_buf_get_keymap(0, mode)
    require("core.cheatsheet").get_mappings(bufkeymaps, tb_to_add)
  end
...
M.autocmds = function(buf)
  require("core.cheatsheet.utils").set_cleanbuf_opts("nvcheatsheet", buf)
  ...
  api.nvim_create_autocmd({ "WinResized", "VimResized" }, {
    group = group_id,
    callback = function()
    --   require("core.cheatsheet." .. config.cheatsheet.theme)(vim.g.nvch_buf, vim.g.nvch_win, "redraw")
      require("core.cheatsheet." .. theme)(vim.g.nvch_buf, vim.g.nvch_win, "redraw")
    --   require("core.cheatsheet" )(vim.g.nvch_buf, vim.g.nvch_win, "redraw")
    end,
  })

  vim.keymap.set("n", "q", function()
    require("core.cheatsheet.utils").close_buffer()
  end, { buffer = buf })

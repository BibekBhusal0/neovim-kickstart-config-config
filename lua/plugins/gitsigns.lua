...
return {
    {
        ...
        config = function()
            ...
            map("n", "<leader>gS", "<cmd>Gitsigns stage_buffer<CR>",
                { noremap = true, silent = true, desc = "Git Stage buffer" })
            map("n", "<leader>gR", "<cmd>Gitsigns reset_buffer<CR>",
                { noremap = true, silent = true, desc = "Git Reset buffer" })
            map("n", "<leader>gh", "<cmd>Gitsigns preview_hunk<CR>",
                { noremap = true, silent = true, desc = "Git Preview hunk" })
            map("n", "<leader>gb", "<cmd>Gitsigns blame<CR>", { noremap = true, silent = true, desc = "Git Blame" })
            map("n", "<leader>gB", "<cmd>Gitsigns blame_line<CR>",
                { noremap = true, silent = true, desc = "Git Toggle line blame" })
            ...
            map("n", "<leader>gt", "<cmd>Gitsigns toggle_signs<CR>",
                { noremap = true, silent = true, desc = "Gitsigns toggle" })
        end
    },
    {
        'tpope/vim-fugitive',

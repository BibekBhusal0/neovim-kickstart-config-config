...
return {
  {
    ...
    keys = wrap_keys{
      ...
      { "<leader>gW", ':lua require("gitsigns").toggle_word_diff()<CR>', desc = "Git Toggle word diff" },
      { "ag", ':lua require("gitsigns").select_hunk()<CR>', desc = "Select hunk", mode = { "o", "x" } },
      { "ig", ':lua require("gitsigns").select_hunk()<CR>', desc = "Select hunk", mode = { "o", "x" } },
    },
  },
}

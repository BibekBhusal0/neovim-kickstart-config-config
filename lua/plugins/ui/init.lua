return {
  require "plugins.ui.alpha", -- Startup page
  require "plugins.ui.bufferline", -- Line that appears at top (showing tabs/buffers)
  require "plugins.ui.colortheme", -- Beautiful colorscheme
  require "plugins.ui.lualine", -- Line that appears at bottom
  require "plugins.ui.others", -- Other stuffs
